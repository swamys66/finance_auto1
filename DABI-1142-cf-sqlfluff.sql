-- this is just a formatting change, so dev should match prod resulting in the query producing no results
WITH 
dev AS (
SELECT 
...
WHERE 1=1
    AND data_month >= '2025-05-20'
    AND data_month < '2025-05-26'
